...
local mappings = {
  ...
  ["f"] = {
    '<cmd>lua require("telescope.builtin").find_files({hidden = true, find_command = { "rg", "--files", "--hidden", "--follow"}})<cr>',
    "Find files",
  },
  ["F"] = { "<cmd>Telescope live_grep theme=ivy hidden=true<cr>", "Find Text" },
  -- ["F"] = { '<cmd>lua require("telescope").extensions.live_grep_args.live_grep_args({hidden = true})<cr>', "Find Text" },
  -- ["F"] = { '<cmd>lua require("telescope.builtin").live_grep({hidden = true, theme=ivy, find_command = { "rg", "--files", "--hidden", "--follow"}})<cr>', "Find Text" },
  ...
  s = {
    ...
    i = { "<cmd>Telescope grep_string theme=dropdown<cr>", "Search Word" },
