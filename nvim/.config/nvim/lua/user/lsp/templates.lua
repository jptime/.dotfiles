...
local ftplugin_dir = user.lsp.templates_dir
...
local skipped_filetypes = user.lsp.automatic_configuration.skipped_filetypes
local skipped_servers = user.lsp.automatic_configuration.skipped_servers
...
function M.generate_ftplugin(server_name, dir)
  ...
  end, user_lsp_utils.get_supported_filetypes(server_name) or {})
