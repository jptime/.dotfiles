...
function M:init(base_dir)
  ...
  require("user.plugin-loader").init {
...
function M:update()
  require_clean("user.utils.hooks").run_pre_update()
  local ret = require_clean("user.utils.git").update_base_lvim()
  if ret then
    require_clean("user.utils.hooks").run_post_update()
  end
end
