...
local function git_cmd(opts)
  ...
  opts = opts or {}
  opts.cwd = opts.cwd or get_user_base_dir()
...
---@param branch string
function M.switch_user_branch(branch)
...
---@return string
function M.get_user_version()
  local current_branch = M.get_user_branch()

  local user_version
  if current_branch ~= "HEAD" or "" then
    user_version = current_branch .. "-" .. M.get_user_current_sha()
  else
    user_version = "v" .. M.get_user_tag()
  end
  return user_version
end
...
---@return string|nil
function M.get_user_current_sha()
