...
function Log:set_level(level)
  ...
  local status_ok, logger = pcall(require("structlog").get_logger "dump")
  if status_ok then
  ...
  require("packer.log").new { level = 'warn'}
end
...
function Log:init()
  ...
  local logger = structlog.get_logger "dump"
...
function Log:get_path()
  return string.format("%s/%s.log", get_cache_dir(), "dump")
end
