...
function M.setup()
  ...
  -- Add useful keymaps
  if #user.builtin.nvimtree.setup.view.mappings.list == 0 then
    user.builtin.nvimtree.setup.view.mappings.list = {
  ...
  nvim_tree.setup(user.builtin.nvimtree.setup)

  if user.builtin.nvimtree.on_config_done then
    user.builtin.nvimtree.on_config_done(nvim_tree)
  end
end
